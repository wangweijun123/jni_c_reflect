...
JNIEXPORT void JNICALL Java_com_example_wangweijun_reflect_JNI_callback
    ...
    LOGD("change log from jni java call c of callback");
    // 找到字节码
...
/*
JNIEXPORT void JNICALL Java_com_example_wangweijun_reflect_JNI_callbackString
        (JNIEnv * env, jobject thiz, jstring in) {

    LOGD("JNI_callbackString in");
//    const char * params = (*env)->GetStringUTFChars(env, in, NULL);
